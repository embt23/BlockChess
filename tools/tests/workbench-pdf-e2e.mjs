...
await p.setInputFiles('#file','/tmp/claude-0/-home-user-BlockChess/1e087d2d-a6f1-50dc-b90d-a89667dace2e/scratchpad/scan.pdf');
...
const IW=1700, IH=1700;                       // the render is square
...
await p.screenshot({path:'wb-pdf-tagged.png'});
await b.close();
